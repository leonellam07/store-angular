...
export class AddInvoiceComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.formAdd = this.fb.group({
      "primerNombre": new FormControl("Jorge", [Validators.required,,Validators.maxLength(20)]) ,
      "segundoNombre": new FormControl("Leonel", [Validators.required,,Validators.maxLength(50)]) ,
      "apellidos": new FormControl("Lam Pazos", [Validators.required,,Validators.maxLength(100)]) ,
      "nit": new FormControl("89646541", [Validators.required,,Validators.maxLength(10)]) ,
      "direccion": new FormControl("Ciudad", [Validators.required,,Validators.maxLength(100)]) ,
  ...
  guardar(){
    ...
    let formauxarray: FormArray = <FormArray>this.formAdd.controls['facturaDetalles']
